...
from .samba_views import HostedSharesView
...
class MountsView(QWidget):
    ...
    def __init__(
        ...
        self._hosted_shares = HostedSharesView()
        self._hosted_shares.shares_changed.connect(
        ...
        description = QLabel(
            "View mounted storage, connect remote shares, and share local folders."
        )
    ...
    def _on_hosted_shares_changed(self) -> None:
        self._hosted_shares.reload()
